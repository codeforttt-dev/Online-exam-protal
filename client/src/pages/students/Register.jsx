...
import { signupUser, checkUsername } from "../../redux/thunks/students/userThunk";
...
import { checkPurchaseThunk } from "../../redux/thunks/students/purchaseThunk";
import { useSelector } from "react-redux";
import { useRef } from "react";
import { fetchSchools } from "../../redux/thunks/school/schoolThunk";
import { resetUsernameStatus } from "../../redux/slices/students/userSlice";
...
useEffect(() => {
  ...
  const { usernameAvailable, usernameChecking,lastCheckedUsername } = useSelector(
    (state) => state.user
  );
            ...
            {step === 1 && (
              <div className="space-y-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      {!usernameChecking &&
                      usernameAvailable === true &&
                      formData.username === lastCheckedUsername && (
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={handleChange}
                      className="w-full px-4 py-3 rounded-xl border border-gray-300 bg-white focus:ring-2 focus:ring-blue-500 outline-none transition duration-200"
                      placeholder="••••••••"
                      required
                    />
                  </div>
                ...
                <div className="bg-amber-50 border border-amber-200 rounded-xl p-4 flex gap-3 items-start">
                  ...
                  <p className="text-sm text-amber-800">
                    <strong>Important:</strong> Your username will be used to access all services of The True Topper platform.
                  </p>
                </div>
